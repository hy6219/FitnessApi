...
public class FitnessRegisterController {
    ...
    public FitnessRegisterController(FitnessService fitnessService){
        this.fitnessService=fitnessService;
    }

    @GetMapping(produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?> getRegisteredFitness(@PageableDefault Pageable pageable, @RequestParam String province, String sort){
        Page<Fitness> info=fitnessService.getFitnessInfo(province,pageable,sort);
